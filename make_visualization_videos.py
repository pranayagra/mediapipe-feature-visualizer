...
if __name__ == '__main__':
	...
	parser.add_argument('--input_frames_directory', type = str, default = 'input/DATA/Frames', help = 'Directory path to raw images.')
	parser.add_argument('--input_mediapipe_directory', type = str, default = 'input/DATA/Mediapipe', help = 'Directory path to raw mediapipe data.')
	parser.add_argument('--input_feature_config_filepath', type = str, default = 'input/configs/features.json', help = 'Filepath to the config file that controls which features are displayed.')
	parser.add_argument('--users', nargs='*', default = None, help = 'The user(s) that will have videos generated for.')
	parser.add_argument('--output_visualization_directory', type = str, default = 'output/visualization', help = 'Directory path to where the video(s) will be saved.')

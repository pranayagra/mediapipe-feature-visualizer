...
def interpolate_feature_data(features_filepath, features, center_on_face: bool = False, is_2d: bool = True, scale: int = 10, drop_na: bool = True):
    ...
    then interpolates using averages for the specified features. Fixes issues with the raw mediapipe data 
    ...
    Pythonify the creation of the dataframe 
    Add more parameters that can impact which features are selected from dataframe (look at feature_selection.py)
    Potentially extend script for 3D data.
